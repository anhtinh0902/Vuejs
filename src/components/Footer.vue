            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <p class="text-justify">
                        ...
                        code. Scanfcode focuses on providing the most efficient
                        code or snippets as the code wants to be simple. We will
                        help programmers build up concepts in different
